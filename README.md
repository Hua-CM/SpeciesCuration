...
**更新日期：2025-05-23**  
1. 目前同时会返回Authorship信息
2. 进一步完善了物种名错误类型的提示，更明确
3. 修复了一些bug
...
[query_species2000_colDB.py](query_species2000_colDB.py)species2000 2021年度版新推出了ColDB格式，该脚本基于该格式中的NameUsage.tsv进行矫正。**使用前需将该文件行名中的"col:"删掉**。推荐使用该脚本，速度快，几秒完成几千个查询。**当前最推荐使用的脚本**
...
2. 上述所有数据库对藻类的支持都不好，故所有脚本目前不包括藻类校正；Species2000对苔藓类的支持也不好，需要人工核对。
